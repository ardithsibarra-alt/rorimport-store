      ...
      <div className="relative bg-white w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-t-[2rem] md:rounded-[2rem] shadow-2xl flex flex-col md:flex-row animate-in slide-in-from-bottom duration-300">
        ...
        <div className="md:w-1/2 p-8 md:p-12 flex flex-col">
          <div className="flex justify-between items-start mb-2">
            ...
            <span className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-bold uppercase ${tieneStock ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'}`}>
              ...
              >
                <div className="relative aspect-[3/4] overflow-hidden bg-[#F9F9F9] mb-6 rounded-2xl">
                  <img 
                    src={product.imagen || product.image} 
                    alt={product.nombre} 
                    className={`w-full h-full object-cover transition-transform duration-1000 ${isOutOfStock ? 'opacity-40 grayscale' : ''}`} 
                  />
                  {isOutOfStock && (
